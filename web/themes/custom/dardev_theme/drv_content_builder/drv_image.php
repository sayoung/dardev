...
if(!class_exists('element_drv_image')):
   class element_drv_image{
      ...
      public static function render_content( $attr, $content = null ){
         ...
         ?>
            ...
            <div class="widget gsc-image<?php if(count($class_array) > 0) print (' ' . implode(' ', $class_array)) ?>"  <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

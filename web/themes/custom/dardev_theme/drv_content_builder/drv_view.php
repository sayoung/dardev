...
if(!class_exists('element_drv_view')):
   class element_drv_view{
      ...
      public function render_content( $attr = array(), $content = '' ){
         ...
         if(isset($_view[0]) && isset($_view[1])){
               ...
               $output .= '<div class="widget block clearfix gsc-block-view  gsc-block-drupal block-view '.implode(' ', $class) .'" ' . dardev_content_builder_print_animate_wow('', $animate_delay) .'>';

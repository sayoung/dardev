<?php 
if(!class_exists('element_drv_icon_box_style')):
   class element_drv_icon_box_style{
         ...
         $fields = array(
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'desc'     => t('Use class icon font <a target="_blank" href="http://fontawesome.io/icons/">Icon Awesome</a> or <a target="_blank" href="http://dardevthemes.com/icons/ionicon/">Custom icon</a>'),
               ),
               array(
                  'id'        => 'image',
                  'type'      => 'upload',
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <?php if($style == 'style-1' || $style == 'style-2' || $style == 'style-4'){ ?>
            <div class="widget gsc-icon-box-new <?php if(count($class)>0) print implode(' ', $class) ?>" <?php if(count($css) > 0) print 'style="'.implode(';', $css).'"' ?> <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>
               <?php if($icon){ ?>

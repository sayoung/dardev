<?php 
if(!class_exists('element_drv_text_rotate')):
   class element_drv_text_rotate{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ?>
            ...
            <div class="widget gsc-text-rotate <?php print $el_class ?> align-<?php print $align ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

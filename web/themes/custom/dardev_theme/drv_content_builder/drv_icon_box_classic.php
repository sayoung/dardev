<?php 
if(!class_exists('element_drv_icon_box_classic')):
   class element_drv_icon_box_classic{
      public function render_form(){
         ...
         $fields = array(
            'type' => 'element_drv_icon_box_classic',
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'options'       => array(
                     ''                     => t('--None--'),
                     'text-left'            => 'Top Left', 
                     'text-right'           => 'Top Right',
                     'text-center'          => 'Top Center',
                     'right'                => 'Right',
                     'left'                 => 'Left',
                  ),

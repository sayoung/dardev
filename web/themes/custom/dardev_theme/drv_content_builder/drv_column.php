...
class element_drv_column{
	...
	public function render_content( $settings = array(), $content = '' ) {
      ...
      $column_class = implode(' ', $array_class);
		...
		<div <?php if($id_column) print 'id="'.$id_column.'"' ?> class="<?php print trim($column_class); ?>" <?php echo(($column_style) ? 'style="'.$column_style.'"' : '');  ?>>
				<?php print $content; ?>
      ...
      ?>
        <div style="background-repeat: <?php print $bg_repeat; ?>;background-position:<?php print $bg_position ?>;" class="<?php print $col_bg_size ?> drv-parallax-inner skrollable skrollable-between" <?php print $data_parallax ?>></div>
       <?php } ?>  
	    </div>

<?php 
if(!class_exists('element_drv_tabs_content')){
   class element_drv_tabs_content{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start() ?>
         <div class="gsc-tabs-content <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

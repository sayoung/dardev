...
<div id="dardev_slider_single" style="background-size: cover; margin:0 auto;width:<?php print $width ?>; height: <?php print $height ?>; border: 1px solid #ccc; list-style: none;position: relative;">
  
</div>

<div class="vertical-tabs layer-single-settingsss layer-settings__lg clearfix">
  <div class="vertical-tabs-list">
  <ul id="dardev_list_layers">    
  </ul>
  ...
  <div class="vertical-tabs-panes vertical-tabs-processed" id="layeroptions" style="display: none">
    ...
    <div class="dardev-heading">Layer Style Setting</div>
        ...
        <td colspan="3">
          <div id="content-type" style="margin-top: 20px;">
            <div id="content-text" class="g-content-setting" style="border: none; padding-top: 20px;border-top: 1px solid #ccc;">
              <div style="width: 50%; float:left;">
                <div style="float: left; width: 36%; display: none;">
                  ...
                  <?php print dardev_defined_select('text_style', dardev_sliderlayer_captionclasses(),'layer-option'); ?>
                </div>
            ...
            <div id="content-image" class="g-content-setting filed-upload-layer-content" style="display: none;">
              <?php print dardev_sliderlayer_field_upload_layer(); ?>
            </div>
    ...
    <fieldset class="fieldset-wrapper g-wrapper">
      <div class="dardev-heading">Layer Setting</div>
      <table style="padding: 10px 20px 20px 20px;">
        <tr>
          <td width="65%">
            ...
            <?php if(dardev_sliderlayer_styles()){ 
              $styles = dardev_sliderlayer_styles(); 
            ?>
              <div style="float: left; width: 33%;">
    ...
    <fieldset class="form-wrapper g-wrapper">
      <div class="dardev-heading">Layer Transition Effects</div>
        ...
        <tr>
          ...
          <div class="g-label">Incoming Effect</div>
            <select name="incomingclasses" class="layer-option">
              <?php foreach (dardevGetArrAnimations() as $key => $value) { ?>
          ...
          <td>
            ...
            <div><?php print dardev_defined_select('data_easing', dardev_sliderlayer_dataeasing(),'layer-option'); ?></div>
          </td>
          <td  width="30%">
        ...
        <tr>
          <td>
            ...
            <select name="outgoingclasses" class="layer-option">
              <?php foreach (dardevGetArrEndAnimations() as $key => $value) { ?>
                  <option value="<?php print $key ?>" <?php if(isset($value['disable']) && ($value['disable']==true)) print 'disabled' ?>><?php print $value['handle']; ?></option>
             <?php } ?>
            </select>
          </td>
          <td>
            ...
            <?php print dardev_defined_select('data_endeasing', dardev_sliderlayer_dataendeasing(),'layer-option'); ?>
          </td>
          <td width="30%">
            <div> 

...
namespace Drupal\dardev_hook_themer;
...
class TwigExtension extends AbstractExtension {
  ...
  public function getFunctions() {
    return [
      new TwigFunction('drv_drupal_view', 'views_embed_view'),
      new TwigFunction('drv_drupal_block', [$this, 'drupalBlock']),
      new TwigFunction('drv_drupal_token', [$this, 'drupalToken']),
      new TwigFunction('drv_drupal_entity', [$this, 'drupalEntity']),
      new TwigFunction('drv_drupal_field', [$this, 'drupalField']),
      new TwigFunction('drv_drupal_menu', [$this, 'drupalMenu']),
      new TwigFunction('drv_drupal_config', [$this, 'drupalConfig']),
      new TwigFunction('drv_theme_setting', [$this, 'themeSetting']),
    ];
  }

<?php 
if(!class_exists('element_drv_progress_work')):
   class element_drv_progress_work{
      public function render_form(){
         $fields = array(
            'type' => 'element_drv_progress_work',
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="widget gsc-progress-box <?php if(count($class)>0) print implode(' ', $class) ?>" <?php if($style) print $style;?> <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

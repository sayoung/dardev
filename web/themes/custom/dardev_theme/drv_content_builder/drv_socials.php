<?php 
if(!class_exists('element_drv_socials')):
   class element_drv_socials{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="widget gsc-socials <?php print implode(' ', $class) ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>
            <div class="socials">
               <?php for($i=1; $i<=10; $i++){ ?>

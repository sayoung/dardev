<?php 
if(!class_exists('element_drv_quote_text')):
   class element_drv_quote_text{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ?>
            ...
            <div class="widget gsc-quote-text <?php print $el_class ?>" <?php print ($background ? "style=\"background:{$background};\"" : '') ?> <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

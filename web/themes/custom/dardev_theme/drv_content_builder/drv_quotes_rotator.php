<?php 
if(!class_exists('element_drv_quotes_rotator')):
   class element_drv_quotes_rotator{
      public function render_form(){
         $fields = array(
            'title'  => t('Quotes Rotator'),
            //'key'      => 'drv_quotes_rotator',
            'fields' => array(
               array(
                  'id'     => 'title',
                  'type'      => 'text',
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="gsc-quotes-rotator <?php print $skin_text ?> <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

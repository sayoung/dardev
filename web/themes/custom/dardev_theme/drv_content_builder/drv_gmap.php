<?php 
if(!class_exists('element_drv_gmap')):
   class element_drv_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       ?>
         ...
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('dardev_theme')) ?>/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('dardev_theme')) ?>/vendor/jquery.ui.map.min.js"></script>

         <div class="gsc-map <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

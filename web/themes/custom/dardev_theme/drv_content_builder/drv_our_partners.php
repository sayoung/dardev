<?php 
if(!class_exists('element_drv_our_partners')):
   class element_drv_our_partners{
      ...
      public static function render_content( $attr, $content = null ){
         ...
         ?>
            ...
            <div class="widget gsc-our-partners <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>
               <?php if($image){ ?>

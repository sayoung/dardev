...
/**
 * @file
 * Contains \Drupal\dardev_hook_themer\Controller\DrvAjaxController.
 */

namespace Drupal\dardev_hook_themer\Controller;
...
class DrvAjaxController extends ControllerBase {

   public function dardev_ajax_view() {
      $view = $_REQUEST['view'];
      if($view){

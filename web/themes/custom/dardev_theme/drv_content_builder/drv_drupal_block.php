<?php 
if(!class_exists('element_drv_drupal_block')):
   class element_drv_drupal_block{
         ...
         $fields = array(
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'options'   => dardev_content_builder_get_blocks_options(),
      ...
      public function render_content( $settings = array(), $content = '' ) {
         ...
         if($block_drupal){
            $output .= '<div class=" clearfix widget gsc-block-drupal '.implode(' ', $class) . '" ' . dardev_content_builder_print_animate_wow('', $animate_delay) . '>';
              $output .= dardev_content_builder_render_block($block_drupal);
            $output .= '</div>';
         } 
         return $output;  
      }

...
if(!class_exists('element_drv_counter')):
   class element_drv_counter{
      public function render_form(){
         $fields = array(
            'type' => 'element_drv_counter',
            'title' => ('Counter'),
            'fields' => array(
               array(
                  'id'        => 'title',
               ...
               array(
                  ...
                  'type'      => 'text',
                  'std'       => '',
                  'desc'     => t('Use class icon font <a target="_blank" href="http://fontawesome.io/icons/">Icon Awesome</a> or <a target="_blank" href="http://dardevthemes.com/icons/">Custom icon</a>'),
               ),
               array(
                  'id'        => 'number',
                  'title'     => t('Number'),
      ...
      public function render_content( $attr = array(), $content = '' ){
         ...
         ?>
            ...
            <div class="widget milestone-block <?php if(count($class) > 0){ print implode(' ', $class); } ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>
               <?php if($icon){ ?>

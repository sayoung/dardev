 ...
 * @ViewsStyle(
 *   id = "drvowlteam",
 *   title = @Translation("Dardev Owl Carousel Team"),
 *   help = @Translation("Displays items as Owl Carousel Team."),
 *   theme = "views_view_drvowlteam",
 *   display_types = {"normal"}
 * )
 */
class drvowlteam extends StylePluginBase {

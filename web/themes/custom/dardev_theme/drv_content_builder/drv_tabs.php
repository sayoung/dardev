<?php 
if(!class_exists('element_drv_tabs')){
   class element_drv_tabs{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start() ?>
         <div class="gsc-tabs <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

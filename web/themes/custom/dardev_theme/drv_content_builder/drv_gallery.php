...
if(!class_exists('element_drv_gallery')):
   class element_drv_gallery{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="gsc-our-gallery <?php echo $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>> 

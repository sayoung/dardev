<?php 
if(!class_exists('element_drv_progress')):
   class element_drv_progress{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="widget gsc-progress<?php if(count($class_array)) print (' ' . implode(' ', $class_array)) ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

<?php 
if(!class_exists('element_drv_progress_work_list')):
   class element_drv_progress_work_list{
      public function render_form(){
         $fields = array(
            'type'      => 'drv_progress_work_list',
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $_id = 'workprocess-' . dardev_content_builder_makeid();
         $classes = $el_class;
         ob_start();
         ?>
         
         <div class="gsc-workprocess-list <?php print $classes ?>" id="<?php print $_id; ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

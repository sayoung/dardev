<?php
if(!class_exists('element_drv_pricing_item')):
   class element_drv_pricing_item{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="pricing-table <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>
            <?php if($featured=='on'){ ?>

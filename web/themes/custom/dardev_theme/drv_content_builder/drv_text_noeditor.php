<?php 
if(!class_exists('element_drv_text_noeditor')):
   class element_drv_text_noeditor{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $ouput = '';
         $ouput .= '<div class="column-content '.$el_class.'" '. dardev_content_builder_print_animate_wow('', $animate_delay) .'>';
         $ouput .= ( $content );
         $ouput .= '</div>';
         return $ouput;
      }

<?php 
if(!class_exists('element_drv_links')):
   class element_drv_links{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="gsc-links gv-sticky-menu <?php echo $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>> 

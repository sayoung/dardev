<?php 
if(!class_exists('element_drv_job_box')):
   class element_drv_job_box{ 
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="widget drv-job-box clearfix <?php print $el_class; ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

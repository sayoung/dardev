...
<div id="dardev_sliderlayer">
  ...
  <div>
    ...
    <div id="dardev_sliderlayer_main">
      <div class="g-wrapper">
       <div class="dardev-heading">Slide options</div>
        <table>
          <tr>
            <td width="33%">
          ...
          <tr>
            <td style="position: relative;">
              ...
              <?php print dardev_sliderlayer_field_upload_slider(); ?>
            </td>
          ...
          <tr>
            <td>
              ...
              <?php print dardev_defined_select('data_transition', dardev_sliderlayer_datatransition(),'slide-option'); ?>
            </td>
            <td>
              <label>Slide Easing In</label>
              <?php print dardev_defined_select('slide_easing_in', dardev_sliderlayer_dataeasing_slide(),'slide-option'); ?>
            </td>
            <td>
              <label>Slide Easing Out</label>
              <?php print dardev_defined_select('slide_easing_out', dardev_sliderlayer_dataeasing_slide(),'slide-option'); ?>
            </td>
          </tr>
       ...
       <div class="clearfix">
        <?php include \Drupal::service('extension.list.module')->getPath('dardev_sliderlayer') . '/templates/backend/layers.php'; ?>
      </div>
      </div>
    </div>
  </div>

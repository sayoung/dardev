<?php 
if(!class_exists('element_drv_button')):
   class element_drv_button{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <a href="<?php print $link ?>" class="gsc-button <?php print implode('', $classes) ?>" id="<?php print $_id; ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>
            <?php print $title ?>
         </a> 

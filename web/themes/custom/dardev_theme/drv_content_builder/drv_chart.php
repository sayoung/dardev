<?php 
if(!class_exists('element_drv_chart')):
   class element_drv_chart{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="widget gsc-chart <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

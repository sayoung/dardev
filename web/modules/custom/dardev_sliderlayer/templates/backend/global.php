<div class="dardev-sliderlayer-groupsetting">
  <fieldset class="form-wrapper g-wrapper">
    <div class="dardev-heading">Global Settings</div>
    ...
    <div class="form-global-setting-item">
      <label>Slide Height Default</label>
      <input type="number" name="gridheight" class="form-text slidergroup-settings"/>
    </div>
    <div class="form-global-setting-item">
      <label>Slide Height For Small Screen</label>
      <input type="number" name="gridheight_sm" class="form-text slidergroup-settings"/>
    </div>
    <div class="form-global-setting-item">
      <label>Slide Height For Extra Small Screen</label>
      <input type="number" name="gridheight_xs" class="form-text slidergroup-settings"/>
    </div>
     <div class="form-global-setting-item">
  ...
  <fieldset class="form-wrapper g-wrapper">
    <div class="dardev-heading">Layout Style</div>
    <div class="form-global-setting-item">
  ...
  <fieldset class="form-wrapper g-wrapper">
    <div class="dardev-heading">Navigation Settings</div>
    <div class="form-global-setting-item">
   ...
   <!-- Arrow -->
    <fieldset class="form-wrapper g-wrapper">
      <div class="dardev-heading">Arrow</div>
      <div class="form-global-setting-item">
    ...
    <fieldset class="form-wrapper g-wrapper">
      <div class="dardev-heading">Bullets</div>
      <div class="form-global-setting-item">
    ...
    <fieldset class="form-wrapper g-wrapper">
      <div class="dardev-heading">Disable Progress Bar</div>
      <div class="form-global-setting-item">

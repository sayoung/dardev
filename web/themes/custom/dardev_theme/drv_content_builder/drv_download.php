...
if(!class_exists('element_drv_download')):
   class element_drv_download{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ?>
            ...
            <div class="gsc-box-download <?php echo $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>> 

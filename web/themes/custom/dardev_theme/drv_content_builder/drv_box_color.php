...
if(!class_exists('element_drv_box_color')):
   class element_drv_box_color{
      ...
      public static function sc_box_color( $attr, $content = null ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-box-color clearfix <?php print $el_class; ?>" <?php print $css ?> <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>

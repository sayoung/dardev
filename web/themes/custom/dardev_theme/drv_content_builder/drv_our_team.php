...
if(!class_exists('element_drv_our_team')):
   class element_drv_our_team{
      ...
      public static function render_content( $attr, $content = null ){
         ...
         //Style display horizontal
          if($style=='horizontal'){ ?>
            <div class="widget gsc-team team-horizontal <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="row">
         ...
         if($style=='vertical'){ ?>
            <div class="widget gsc-team team-vertical <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow($animate) ?>>
         ...
         //circle
         if($style=='circle'){ ?>
            <div class="widget gsc-team team-circle <?php print $el_class ?>" <?php print dardev_content_builder_print_animate_wow($animate) ?>>
               <div class="widget-content text-center">
                  <div class="team-header text-center">
                     <img alt="<?php print $title; ?>" src="<?php print $image ?>" class="img-responsive"> 
                     <div class="box-hover">

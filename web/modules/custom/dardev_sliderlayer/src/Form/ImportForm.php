...
class ImportForm implements FormInterface {
   ...
   */
   public function buildForm(array $form, FormStateInterface $form_state) {
      ...
      if($group['id']==0){
        \Drupal::messenger()->addMessage('Not found dardev slider layer !');
        return false;
      }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($form['gid']['#value']) {
      ...
      $builder = \Drupal::database()->update("dardev_sliderlayergroups")
      ->fields(array(
      ...
      if($slideshow->sliders){
        \Drupal::database()->delete('dardev_sliderlayers')->condition('group_id', $gid)->execute();
      ...
      $response = new \Symfony\Component\HttpFoundation\RedirectResponse(Url::fromRoute('dardev_sl_group.admin', array('gid'=>$gid))->toString());
      $response->send();
    }  
  }
}